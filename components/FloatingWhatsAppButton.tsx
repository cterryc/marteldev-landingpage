...
const FloatingWhatsAppButton: React.FC = () => {
  return (
    <div className='fixed bottom-8 right-8 z-50'>
      <button
        onClick={() =>
          contactWhatsApp('Hola! Tengo una consulta sobre este template')
        }
        className='w-16 h-16 bg-primary rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform group'
